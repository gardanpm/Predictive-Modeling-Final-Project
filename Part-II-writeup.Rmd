...
```
Significant interactions: year:discauth* + year:artistliving* + Interm:discauth*** +
...
predictions = as.data.frame(
  exp(confint(predict(bma2, newdata = paintings_train %>% impute_NA(), 
...
predictions = as.data.frame(
  exp(confint(predict(bma2, newdata = paintings_test %>% impute_NA(), 
