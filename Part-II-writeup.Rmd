...
full_bma <- bas.lm(logprice ~ . - Surface + log(Surface) +
                year:discauth + year:artistliving + Interm:discauth +
                Interm:dealer + prevcoll:finished + discauth:dealer,
...
predictions = as.data.frame(
  exp(confint(predict(full_bma, newdata = paintings_train %>% impute_NA(), 
...
predictions = as.data.frame(
  exp(confint(predict(full_bma, newdata = paintings_test %>% impute_NA(), 
...
predictions = as.data.frame(
  exp(confint(predict(full_bma, newdata = paintings_validation %>% impute_NA(), 
