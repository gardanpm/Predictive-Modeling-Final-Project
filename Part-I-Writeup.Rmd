...
# Recode to pass new levels octogon in new test set
for(i in 1:nrow(paintings_test)){
  if(paintings_test$Shape[i] %in% "octogon"){paintings_test$Shape[i] = "octagon"}
  else{paintings_test$Shape[i] = paintings_test$Shape[i]}
}
