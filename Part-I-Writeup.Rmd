...
paintings_train_subset <- paintings_train %>% 
  ...
  select(logprice, year, lSurface, diff_origin, Interm, engraved, prevcoll,
         paired, figures,finished, lrgfont, lands_sc, peasant, portrait, still_life,
         discauth, dealer, materialCat, endbuyer, Shape, school_pntg)

paintings_train_subset <- impute_NA(paintings_train_subset)

model.init <- lm(logprice ~ . + lSurface:materialCat + school_pntg:diff_origin + 
         dealer:school_pntg + dealer:Interm + dealer:endbuyer + endbuyer:Interm +
         finished:prevcoll, data = paintings_train_subset)
