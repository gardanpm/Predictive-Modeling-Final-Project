...
The goal of part-I is to create a linear regression model and then use model seletion method to choose a model that is able to estimate the price of the paintings better given the sales, painter, and other characteristics of paintings.
...
# Deleting replicates
paintings_train <- paintings_train %>% distinct()
...
paintings_train$Shape <- recode(paintings_train$Shape, ovale = "oval", ronde = "round")
```
