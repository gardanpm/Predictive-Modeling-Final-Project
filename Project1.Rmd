...
\center ## **FIG 3 (Multiple level Factors Vs. logprice)**  
  
```{r multiple lvl, echo=FALSE, message=FALSE, warning=FALSE}
multlvl = paintings_train %>% select(origin_author, origin_cat, school_pntg, 
                                     Shape, material, mat, materialCat, dealer,
                                     winningbiddertype, endbuyer, type_intermed,
                                     logprice)
